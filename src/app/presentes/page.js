                ...
                <div class="row">
                  ...
                  <div class="row">
                    ...
                    <span id="pix-key" style={{ marginRight: "10px" }}>f1d8428e-3d73-4bc2-b8b3-4359a84d5d08
                      ...
                      <svg xmlns="http://www.w3.org/2000/svg" color="blue" class="link-primary bi bi-copy" onClick={handleSvgClick} style={{ marginLeft: "15px" }} width="18" height="18" fill="currentColor" viewBox="0 0 16 16">
